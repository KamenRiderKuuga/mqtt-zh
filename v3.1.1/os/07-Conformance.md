...
3. 它满足以下章节中标识的所有 MUST 级别要求，但仅适用于 Client 的要求除外：
    ...
    - 第 1 章 - Introduction 简介

        - 第 2 章 - MQTT Control Packet format 控制报文格式

        - 第 3 章 - MQTT Control Packets 控制报文

        - 第 4 章 - Operational behavior 操作行为

    - 第 6 章 -（如果 MQTT 通过 WebSocket 连接传输）

    - 第 7 章 - Conformance Targets 一致性目标
